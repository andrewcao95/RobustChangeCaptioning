...
from models_gpu1 import DualAttention, DynamicSpeaker
...
def main(args):
  ...
  train_loader = torch.utils.data.DataLoader(
    CaptionDataset(args.data_folder, data_name, 'TRAIN', captions_per_image),
    batch_size=batch_size, shuffle=True, num_workers=workers, pin_memory=True)

  val_loader = torch.utils.data.DataLoader(
    CaptionDataset(args.data_folder, data_name, 'VAL', captions_per_image),
    batch_size=batch_size, shuffle=True, num_workers=workers, pin_memory=True)
  ...
  for epoch in range(start_epoch, args.epochs):
    ...
    # Save checkpoint
    save_checkpoint(args.root_dir, data_name, epoch, epochs_since_improvement, encoder, decoder, encoder_optimizer, decoder_optimizer, recent_bleu4, is_best)
